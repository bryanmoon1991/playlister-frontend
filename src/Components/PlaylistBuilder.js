...
const PlaylistBuilder = ({
	...
	const togglePreviewed = () => {
		if (stateRef.current.previewed) {
			setState((prevState) => ({ ...prevState, previewed: false }));
		} else {
			setState((prevState) => ({ ...prevState, previewed: !state.previewed }));
		}
	};
						...
						>
							...
							<Modal.Actions>
								<Button
									...
									positive
									disabled={stateRef.current.previewed}
								/>
								<Button
									content="Publish"
									labelPosition="right"
